...
```groovy
implementation group: "org.http4k", name: "http4k-contract", version: "5.0.0.0"
implementation group: "org.http4k", name: "http4k-format-<insert json lib>", version: "5.0.0.0"
```
